...
import {
  addFocusFn,
  removeFocusFn
} from '../../utils/private/focus-manager.js';
...
export default function(state) {
  ...
  function clearValue(e) {
    ...
    if ($q.platform.is.mobile !== true) {
      const el =
        (state.targetRef !== void 0 && state.targetRef.value) ||
        state.rootRef.value;
      el.focus();
  ...
  return function renderField() {
    return h(
      'label',
      {
        ref: state.rootRef,
        class:
          state.inheritAttrs !== true
            ? [classes.value, attrs.class]
            : classes.value,
        style: attrs.style,
        ...attributes.value
      },
      [
        ...
        slots.after !== void 0
          ...
          : null,
        hasError.value === true &&
          h('error', [h('div', { class: 'q-ml-sm' }, 'aaa')])
      ]
    );
  };
}
