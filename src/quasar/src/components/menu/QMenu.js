...
import useAnchor, {
  useAnchorProps
} from '../../composables/private/use-anchor.js';
...
import useTransition, {
  useTransitionProps
} from '../../composables/private/use-transition.js';
...
import {
  addClickOutside,
  removeClickOutside
} from '../../utils/private/click-outside.js';
...
export default defineComponent({
  ...
  setup(props, { slots, emit, attrs }) {
    ...
    function renderPortalContent() {
      return h(Transition, { name: transition.value, appear: true }, () =>
        showing.value === true
          ? h(
              'div',
              {
