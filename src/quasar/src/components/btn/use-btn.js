...
import useAlign, {
  useAlignProps
} from '../../composables/private/use-align.js';
import useSize, { useSizeProps } from '../../composables/private/use-size.js';
import useRouterLink, {
  useRouterLinkProps
} from '../../composables/private/use-router-link.js';
...
export default function(props) {
  ...
  const design = computed(() => {
    if (props.liner === true) return 'liner';
    if (props.func === true) return 'func';
    if (props.flat === true) return 'flat';
    if (props.dash === true) return 'dash';
    if (props.font === true) return 'font';
    if (props.fontDark === true) return 'font-dark';
  ...
  const classes = computed(() => {
    ...
    return (
      ...
      `q-btn--${
        props.round === true
          ? 'round'
          : `rectangle${isRounded.value === true ? ' q-btn--rounded' : ''}`
      }` +
